...
//  Manga Storage
//
//  Created by Thiago Augusto on 25/03/19.
...
//    func validated(_ value: String?) throws -> String {
//        do {
//            if let value = value, try NSRegularExpression(pattern: "^[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}$", options: .caseInsensitive).firstMatch(in: value, options: [], range: NSRange(location: 0, length: value.count)) == nil {
